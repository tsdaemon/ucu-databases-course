...
User name, password, database name you have defined in the `db.sql`. Host is usually `localhost`,
when you test your application locally. But in other environments (on production, or in the test 
environment) database host might be different. 
